...
export async function GET() {
  ...
  try {
    ...
    for (const unit of allUnits) {
      ...
      // Include units marked as vacant or available
      ...
      // Use unit address if available, fall back to property address
      ...
      // Build unit name/address with unit number if multi-unit
